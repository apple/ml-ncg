"""This module implements the Alternate optimization algorithm harness
...
from optimization import NCG_OPTIMIZER_TFOP
...
class AltOptimizer(gradient_descent.GradientDescentOptimizer):
    ...
    def apply_gradients(self, grads_and_vars, global_step=None, name=None):
        ...
        if self.lars_lr > 0.0:
            grads_and_vars = lars_grads_and_vars(grads_and_vars, self.lars_lr)
